...
const successStories = [
  ...
  { id: 9, name: "Nepal vs Thailand match", image: photo3, message: "Nepal vs Thailand match" },
  { id: 10, name: "Nepal vs Thailand match", image: photo4, message: "Nepal vs Thailand match " },
  { id: 11, name: "Mr. Pujan Neupana", image: photo5, message: "our success cheju halla university Topper Thank You for Trusting Us " },
  { id: 12, name: "Batch 2018 Intake", image: photo6, message: "Living the dream life in South korea! Thank You for Trusting Us" },
  { id: 13, name: "Batch 2018 Intake", image: photo7, message: "Living the dream life in South korea! Thank You for Trusting Us" },
